...
<div class="right">
        ...
        <div class="providerAdd">
          <form id="billForm" name="billForm" method="post" action="${pageContext.request.contextPath }/billManagement.do">
                ...
                <div>
					...
					<select name="providerId" id="providerId">
                        <c:forEach var="pro" items="${providerList}">
                            <option <c:if test="${pro.id == bill.providerId}">selected="selected"</c:if>
