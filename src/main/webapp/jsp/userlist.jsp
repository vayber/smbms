...
<%@include file="common/head.jsp"%>
        ...
        <div class="right">
            ...
            <div class="search">
           		<form method="get" action="${pageContext.request.contextPath }/management.do">
					<input type="hidden" name="method" value="queryList">
					<input type="hidden" name="pageIndex" value="1"/>
					 <span>用户名：</span>
													<%--	${queryUserName} 取后端的值	req.setAttribute("queryUserName",queryUserName); --%>
					 <input name="queryname" class="input-text"	type="text" value="${queryUserName}">



					 <span>用户角色：</span>
					 <select name="queryUserRolesss">
